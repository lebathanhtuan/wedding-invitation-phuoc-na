export const vi = {
  ...
  invitation: {
    ...
    subRestaurant: 'Ủy Ban Nhân Dân',
    restaurant: 'Xã Điện Bàn Tây',
    address: 'Thôn Phong Thử, Xã Điện Bàn Tây, Thành Phố Đà Nẵng',
    time: 'VÀO LÚC 10 GIỜ 30',
    date: 'NGÀY',
    DD: '29',
    dddd: 'CHỦ NHẬT',
    MMMM: 'THÁNG 3',
    YYYY: '2026',
    viDate: '(Nhằm ngày 11 tháng 02 năm Bính Ngọ)',
    schedule: 'Đón khách: 10 giờ 30 - Khai tiệc: 11 giờ 30',
  },
  loveStory: {
    title: 'Chúng mình',
